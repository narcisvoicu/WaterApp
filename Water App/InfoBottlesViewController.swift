...
class InfoBottlesViewController: UIViewController {
    ...
    @IBOutlet weak var infoBottlesImageView: UIImageView!
...
//        }
        ...
        let imageBottleRef = DataService.dataService.rootRef.childByAppendingPath("bottles").childByAppendingPath(bottleName.text!.lowercaseString).childByAppendingPath("image")
    ...
    func decodeImage(){
        ...
        infoBottlesImageView.image = decodedImage
    }
